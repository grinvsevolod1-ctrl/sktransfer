...
export const translations = {
  ru: {
    ...
    about: {
      ...
      feature2Desc:
        "Современный автопарк от седанов класса бизнес до микроавтобусов. Все автомобили в идеальном состоянии.",
  ...
  en: {
    ...
    about: {
      ...
      feature2Desc: "Modern fleet from business class sedans to minibuses. All vehicles in perfect condition.",
  ...
  zh: {
    ...
    about: {
      ...
      feature2: "高端车辆",
      feature2Desc: "从商务轿车到小巴的现代车队。所有车辆状况完美。",
      feature3: "准时性",
