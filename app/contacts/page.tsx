...
export const metadata: Metadata = {
  ...
  description:
    "Связаться с SK Transfer: телефон +375 (29) 122-84-84, email info@sktransfer.by. Работаем 24/7 без выходных. Telegram, WhatsApp, Viber. Офис в Минске, Беларусь. Быстрый ответ в течение нескольких минут.",
  keywords: [
