      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16">
          <div className="space-y-4 sm:space-y-6">
            <div className="relative min-h-[400px] max-h-[600px] rounded-2xl overflow-hidden border-2 border-[var(--gold)]/30 shadow-2xl bg-gray-50">
          ...
          <div className="space-y-6 sm:space-y-8 min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="glass-effect rounded-xl p-4 sm:p-6 border border-[var(--gold)]/20 min-w-0">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {locale === "ru" ? "Двигатель" : locale === "en" ? "Engine" : "发动机"}
                  </span>
                </div>
              ...
              <div className="glass-effect rounded-xl p-4 sm:p-6 border border-[var(--gold)]/20 min-w-0">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {locale === "ru" ? "Пассажиры" : locale === "en" ? "Passengers" : "乘客"}
                  </span>
                </div>
                ...
                <p className="text-xs sm:text-sm text-[var(--gold-dark)] mt-1">
                  {locale === "ru" ? "человек" : locale === "en" ? "people" : "人"}
                </p>
              </div>
            ...
            <div className="glass-effect rounded-xl p-4 sm:p-6 border border-[var(--gold)]/20">
              <h3 className="text-lg sm:text-xl font-bold text-foreground mb-4 flex items-center gap-2">
                ...
                {locale === "ru" ? "Особенности" : locale === "en" ? "Features" : "特点"}
              </h3>
