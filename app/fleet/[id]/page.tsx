  ...
  return [
    {
      ...
      images: [
        "/black-volkswagen-passat-sedan-premium.jpg",
        "/black-volkswagen-passat-sedan-premium.jpg",
        "/black-volkswagen-passat-sedan-premium.jpg",
        "/black-volkswagen-passat-sedan-premium.jpg",
      ],
      ...
      details: {
        ...
        description:
          locale === "ru"
            ? "Идеален для деловых поездок и комфортных путешествий на средние расстояния. Просторный салон с кожаной отделкой."
            : locale === "en"
              ? "Perfect for business trips and comfortable medium-distance travel. Spacious interior with leather trim."
              : "适合商务旅行和中等距离的舒适旅行。宽敞的内饰配有真皮装饰。",
        features: [
    ...
    },
    {
      ...
      images: [
        "/black-mercedes-e-class-luxury-sedan.jpg",
        "/black-mercedes-e-class-luxury-sedan.jpg",
        "/black-mercedes-e-class-luxury-sedan.jpg",
        "/black-mercedes-e-class-luxury-sedan.jpg",
      ],
...
export default async function VehiclePage() {
  const locale = "ru" // Default locale, can be dynamic based on request
  const vehicles = await getVehicles(locale as Locale)
