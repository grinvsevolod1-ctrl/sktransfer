...
export const metadata: Metadata = {
  ...
  description:
    "Опытные профессиональные гиды в Минске и по Беларуси. Индивидуальные и групповые экскурсии на русском, английском, китайском языках. Авторские маршруты по историческим места��, музеям, достопримечательностям. Бронирование онлайн 24/7.",
  keywords: [
    "гид Минск",
    "экскурсовод Минск",
    "гид по Беларуси",
