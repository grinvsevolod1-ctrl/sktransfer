...
const excursionsData = {
  "minsk-city-tour": {
    ...
    duration: { ru: "3-4 часа", en: "3-4 hours", zh: "3-4小时" },
    groupSize: { ru: "до 15 человек", en: "up to 15 people", zh: "最多15人" },
    price: { ru: "от 150 BYN", en: "from 150 BYN", zh: "150卢布起" },
    images: [
  ...
  "brest-fortress": {
    ...
    price: { ru: "от 250 BYN", en: "from 250 BYN", zh: "250卢布起" },
    images: [
  ...
  "mir-nesvizh": {
    ...
    duration: { ru: "Полный день", en: "Full day", zh: "全天" },
    groupSize: { ru: "до 15 человек", en: "up to 15 people", zh: "最多15人" },
    price: { ru: "от 200 BYN", en: "from 200 BYN", zh: "200卢布起" },
    images: [
  ...
  "khatyn-memorial": {
    ...
    groupSize: { ru: "до 20 человек", en: "up to 20 people", zh: "最多20人" },
    price: { ru: "от 120 BYN", en: "from 120 BYN", zh: "120卢布起" },
    images: [
  ...
  "belovezhskaya-pushcha": {
    ...
    duration: { ru: "Полный день", en: "Full day", zh: "全天" },
    groupSize: { ru: "до 15 человек", en: "up to 15 people", zh: "最多15人" },
    price: { ru: "от 280 BYN", en: "from 280 BYN", zh: "280卢布起" },
    images: [
