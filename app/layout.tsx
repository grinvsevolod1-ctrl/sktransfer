...
export const metadata: Metadata = {
  ...
  title: {
    default: "SKTransfer.by — Премиум трансфер по Беларуси, России и Европе | Заказ онлайн 24/7",
    template: "%s | SKTransfer.by",
  },
  description:
    "Профессиональные трансферы премиум-класса по Беларуси, России, СНГ и Европе. Индивидуальные поездки, VIP-обслуживание, комфортабельные автомобили Mercedes. Трансфер в аэропорт Минск от 45 BYN, экскурсии с опытными гидами, поездки в горнолыжные курорты и санатории. Онлайн калькулятор стоимости. Заказ онлайн 24/7.",
  keywords: [
    "трансфер Минск",
    "трансфер Беларусь",
  ...
  openGraph: {
    ...
    title: "SKTransfer.by — Премиум трансферы по Беларуси, России и Европе",
    description:
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    description:
      "Профессиональные трансферы премиум-класса по Беларуси, России и Европе. Индивидуальные поездки, VIP-обслуживание.",
    address: {
      "@type": "PostalAddress",
    ...
    foundingDate: "2008",
    slogan: "Премиум трансферы по Беларуси, России и Европе",
  }
  ...
  const serviceSchema = {
    ...
    description: "Премиум трансферы и экскурсии по Беларуси, России и Европе",
    provider: {
      "@type": "Organization",
      name: "SK Transfer",
      url: "https://sktransfer.by",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            ...
            description: "Премиум трансфер на Mercedes S-Class с личным водителем",
          },
          price: "140",
          priceCurrency: "BYN",
        },
  ...
  return (
    <html className="" lang="ru">
      <head>
        ...
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/105940841" style={{ position: "absolute", left: "-9999px" }} alt="" />
          </div>
        </noscript>
