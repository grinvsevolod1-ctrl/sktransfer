          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-4 sm:mb-6 group relative">
              ...
              <svg
                ...
                viewBox="0 0 200 70"
                className="h-16 sm:h-20 w-auto relative drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]"
                width="150"
                height="80"
              >
                <defs>
            ...
            <div className="flex gap-2 sm:gap-3">
              <a
                ...
                aria-label="Telegram"
              >
                <Send className="h-4 w-4 sm:h-5 sm:w-5 text-white drop-shadow-md" />
              </a>
              <a
                ...
                aria-label="WhatsApp"
              >
                <MessageCircle className="h-4 w-4 sm:h-5 sm:w-5 text-white drop-shadow-md" />
              </a>
              <a
                ...
                aria-label="Viber"
              >
                <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-white drop-shadow-md" />
              </a>
            </div>
          </div>
