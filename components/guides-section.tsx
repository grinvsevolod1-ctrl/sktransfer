            ...
            <div className="p-6 sm:p-8 bg-white">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-4 sm:mb-6">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2 group-hover:text-[var(--gold)] transition-colors">
                    {guide.name}
                  </h3>
                  <p className="text-sm sm:text-base text-[var(--gold)] font-medium mb-2 sm:mb-3 text-muted">{guide.experience}</p>
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-2 flex-wrap">
                    <Languages className="h-3 w-3 sm:h-4 sm:w-4 text-[var(--gold)] flex-shrink-0 text-muted" />
                    {guide.languages.map((lang, i) => (
                      <span
                        key={i}
                        className="text-xs px-2 py-0.5 sm:py-1 bg-[var(--gold)]/10 border border-[var(--gold)]/20 rounded-full text-[var(--gold)] text-muted"
                      >
                        {lang}
                      </span>
                    ))}
              ...
              <p className="text-sm sm:text-base leading-relaxed mb-4 sm:mb-6 line-clamp-3 text-muted">
                {guide.description}
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0 pt-4 sm:pt-6 border-t border-[var(--gold)]/20">
                <div className="flex items-center gap-2">
                  <Award className="h-4 w-4 sm:h-5 sm:w-5 text-[var(--gold)] flex-shrink-0 text-muted" />
                  <span className="text-xs sm:text-sm text-center sm:text-left text-muted">
                    {locale === "ru"
                ...
                <div className="flex items-center gap-2 text-[var(--gold)] font-medium group-hover:gap-3 transition-all">
                  ...
                  <ArrowRight className="h-3 w-3 sm:h-4 sm:w-4 text-muted" />
                </div>
              </div>
            </div>
          </div>
