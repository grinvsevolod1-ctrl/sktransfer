    ...
    <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
      {excursions.map((excursion) => (
        <div key={excursion.id} onClick={(e) => handleExcursionClick(e, excursion.id)} className="group cursor-pointer">
          <div className="bg-white rounded-2xl overflow-hidden border border-gray-200 h-full flex flex-col transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1 hover:border-[var(--gold)]/30">
            <div className="p-6 sm:p-8 flex flex-col flex-1">
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 mb-4 sm:mb-6">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2 line-clamp-2 transition-colors duration-300 group-hover:text-[var(--gold)]">
                    {excursion.name[locale]}
                  </h3>
                  <p className="text-sm sm:text-base text-[var(--gold)] font-medium mb-2 sm:mb-3 text-muted">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0 pt-4 sm:pt-6 border-t border-gray-200 mt-auto">
                <div className="flex items-center gap-2">
                  <Compass className="h-4 w-4 sm:h-5 sm:w-5 text-[var(--gold)] flex-shrink-0 text-muted" />
                  <span className="text-xs sm:text-sm text-gray-600 text-center sm:text-left">
                    {locale === "ru" ? "Профессиональный гид" : locale === "en" ? "Professional guide" : "专业导游"}
                  </span>
                </div>

                <div className="flex items-center gap-2 text-[var(--gold)] font-medium">
