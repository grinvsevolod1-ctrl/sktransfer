...
import { X, Phone, Mail, MapPin, Calculator, Car, Users, Mountain, Sparkles, ChevronRight } from "lucide-react"
...
export function MobileMenuModal({ open, onClose, locale, onLocaleChange, onContactClick }: MobileMenuModalProps) {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className={`font-medium ${isActive ? "text-[var(--gold-light)]" : "text-white"}`}>
                      {link.label}
                    </span>
                  </div>
                  <ChevronRight className={`h-5 w-5 ${isActive ? "text-[var(--gold)]" : "text-white/50"}`} />
                </Link>
              )
            })}
          </nav>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-white/90">
                  <a href="tel:+375291228484" className="hover:text-[var(--gold-light)] transition-colors">
                    +375 (29) 122-84-84
                  </a>
                </div>
              </div>
