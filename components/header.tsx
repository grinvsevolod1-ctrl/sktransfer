...
export function Header() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b border-border/40">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="h-12 sm:h-16 md:h-20 w-32 sm:w-40 md:w-48 bg-muted animate-pulse rounded" />
          </div>
        </div>
      </header>
    )
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <Button
                ...
                size="sm"
                className="md:hidden flex items-center gap-2 bg-white text-gray-900 font-semibold hover:bg-gray-100 border border-white/30 shadow-lg shadow-white/10 hover:shadow-xl hover:shadow-white/20 transition-all duration-300 h-9 px-3"
              >
              ...
              <Button
                onClick={() => setContactModalOpen(true)}
                className="hidden md:flex items-center gap-2 bg-white text-gray-900 font-semibold hover:bg-gray-100 border border-white/30 shadow-lg shadow-white/10 hover:shadow-xl hover:shadow-white/20 transition-all duration-300 hover:scale-105 h-10 px-4 lg:px-6"
              >
              ...
              <Button
                variant="ghost"
                size="sm"
                className="lg:hidden text-white hover:bg-white/10 border border-white/10 hover:border-white/30 shadow-sm hover:shadow-lg transition-all h-9 w-9 p-0"
      ...
      <ContactModal open={contactModalOpen} onClose={() => setContactModalOpen(false)} locale={locale} />
    </>
  )
}
