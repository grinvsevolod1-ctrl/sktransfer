...
const AIRPORT_TARIFFS = {
  ...
  business: {
    from: 140,
    to: 140,
    features: ["1-3 пассажира", "Premium класс", "Детское кресло"],
  },
  minivan: {
    from: 130,
    to: 130,
    features: ["До 8 пассажиров", "Mercedes V-класс", "Больше багажа"],
  },
  vip: {
    from: 160,
    to: 160,
    features: ["1-3 пассажира", "Mercedes S-класс", "Премиум сервис"],
  },
  minibus: {
    from: 220,
    to: 220,
